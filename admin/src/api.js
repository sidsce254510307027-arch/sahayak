...
export const session = {
  get token() { return localStorage.getItem("sahayak_admin_token"); },
  set token(t) { t ? localStorage.setItem("sahayak_admin_token", t) : localStorage.removeItem("sahayak_admin_token"); },
  get user() { const raw = localStorage.getItem("sahayak_admin_user"); return raw ? JSON.parse(raw) : null; },
  set user(u) { u ? localStorage.setItem("sahayak_admin_user", JSON.stringify(u)) : localStorage.removeItem("sahayak_admin_user"); },
